#!/bin/sh
cd app/data
curl -sO "https://s3.amazonaws.com/tripdata/2021[02-12]-citibike-tripdata.csv.zip"
...
curl -sO "https://s3.amazonaws.com/tripdata/2023[01-04]-citibike-tripdata.csv.zip"
